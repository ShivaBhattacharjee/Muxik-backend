    ...
    <tbody>
      ...
      <![endif]-->
          ...
          <div class="u-row-container"
            style="padding: 0px;background-image: url('./images');background-repeat: no-repeat;background-position: center top;background-color: transparent">
            <div class="u-row"
                    ...
                    <div
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:110px 10px;font-family:'Raleway',sans-serif;"
                              align="left">
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  ...
                                  <img align="center" border="0" src="https://cdn.discordapp.com/attachments/1079039236302446705/1133398219804643338/logo-512.png" alt="image" title="image" width="120px" style="border-radius:14px"/>
                      ...
                      <table id="u_content_text_4" style="font-family:'Raleway',sans-serif;" role="presentation"
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding"
                              style="overflow-wrap:break-word;word-break:break-word;padding:60px 50px 33px;font-family:'Raleway',sans-serif;"
                              align="left">
                              ...
                              <div class="v-text-align"
                                ...
                                <p style="line-height: 140%; font-size: 14px;"> </p>
                                <p style="line-height: 140%; font-size: 14px;">We received a request to reset your password for your account at Muxik. If you didn't initiate this request, you can safely ignore this email.</p>
                                ...
                                <p style="line-height: 140%; font-size: 14px;"><span
                                  style="font-size: 14px; line-height: 19.6px;"><strong><span
                                      style="font-family: Raleway, sans-serif; font-size: 25px; line-height: 19.6px;">Reset Password Otp :  \${otp} </span></strong></span></p>
                                      <p style="line-height: 140%; font-size: 14px;"> </p>
                                      <p style="line-height: 140%; font-size: 14px;"> </p>
                                <p style="line-height: 140%; font-size: 14px;"><span
                                    style="font-size: 14px; line-height: 19.6px;"><strong><span
